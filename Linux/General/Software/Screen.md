...
is a terminal multiplexer, allowing a user to access
...
Screen version `4.05.00` allows privilege escalation
...
2. The current user is granted with `root` privileges
